...
public class MethodOne {
	...
	// Methods also know functions and they are reusable in many different areas and
	// times in your project.

	static void sampleMethod() {
		System.out.println("Sample method constructor is called first!");
